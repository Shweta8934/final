...
# print(f"Loaded OPENROUTER_API_KEY: {repr(OPENROUTER_API_KEY)}")
# if not OPENROUTER_API_KEY:
#     raise RuntimeError("❌ Missing OPENROUTER_API_KEY environment variable.")

# APP_URL = os.getenv("APP_URL", "http://localhost:8501")
# APP_NAME = os.getenv("APP_NAME", "AI Tutor App")
...
#     """Fetch quiz questions dynamically from OpenRouter AI."""
